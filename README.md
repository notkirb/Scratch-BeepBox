...
1. [Download the `extension.js` file](https://github.com/notkirb/Scratch-BeepBox/releases/).
...
3. Copy and paste [this link](https://github.com/notkirb/Scratch-BeepBox/releases/) into the text field.
...
2. Copy and paste [this link](https://github.com/notkirb/Scratch-BeepBox/releases/) into a custom extension URL field. 
## Building
