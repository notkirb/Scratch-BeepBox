...
1. [Download the `extension.js` file](https://github.com/notkirb/Scratch-BeepBox/releases/download/latest/extension.js).
...
3. Copy and paste [this link](https://github.com/notkirb/Scratch-BeepBox/releases/download/latest/extension.js) into the text field.
...
2. Copy and paste [this link](https://github.com/notkirb/Scratch-BeepBox/releases/download/latest/extension.js) into a custom extension URL field. 
## Building
...
3. Package project
   ...
   $ npm run build
   ```
4. Use `dist/extension.js` in your Scratch VM of choice
## To-do
| Task | Completion |
|-|-|
